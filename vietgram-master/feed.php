    ...
    <main id="feed">
        ...
        <div class="photo">
            <header class="photo__header">
                <img src="images/feed_izzan/izzanfaikar/gambar2.jpg" class="photo__avatar"/>
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                </div>
            </header>
            <center><img class="img-fluid" height="350px" width="400px" src="images/feed_izzan/izzanfaikar/<?php echo "/".$rows[$i][1]; ?>" /></center>
