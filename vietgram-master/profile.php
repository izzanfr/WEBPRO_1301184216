    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img width="200" heigth="200"src="images/feed_izzan/izzanfaikar/gambar2.jpg" />
            </div>
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    ...
                    <li class="profile__stat">
                        <span class="stat__number">502.345</span> followers
                    </li>
                    <li class="profile__stat">
                        <span class="stat__number">45.876</span> following
                    </li>
                </ul>
        ...
        ?>
            <div class="profile__photo">
                <img width="500px" heigth="500px" src="images/feed_izzan/izzanfaikar/<?php echo "/".$rows[$i][1]; ?>" />
